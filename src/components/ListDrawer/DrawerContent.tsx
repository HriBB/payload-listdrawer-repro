...
import { useThrottledEffect } from '@payloadcms/ui'
import { XIcon } from '@payloadcms/ui'
import { useAuth } from '@payloadcms/ui'
import { useConfig } from '@payloadcms/ui'
import { RenderComponent } from '@payloadcms/ui'
import { ListInfoProvider } from '@payloadcms/ui'
import { ListQueryProvider } from '@payloadcms/ui'
...
import { TableColumnsProvider } from '@payloadcms/ui'
...
export const ListDrawerContent: React.FC<ListDrawerProps> = ({
  ...
  useEffect(() => {
    ...
    if (filterOptions && typeof filterOption !== 'boolean' && typeof filterOption !== 'undefined') {
      copyOfWhere = hoistQueryParamsToAnd(copyOfWhere, filterOption)
    }
    console.log('ping', { slug, copyOfWhere, filterOption })
